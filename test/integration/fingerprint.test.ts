...
import { registerPromptHandler, unregisterPromptHandler, clearAllowlist } from "../../src/permissions/confirm";
...
describe("Fingerprint Journal Integration", () => {
  ...
  it("should scrub output, extract fingerprint via mock LLM, and log to journal", async () => {
    ...
    const command = "echo 'TypeError: null is not an object at /Users/kwang/projects/coding_agent/src/buggy.ts:7:20' >&2 && exit 1";
